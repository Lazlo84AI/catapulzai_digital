...
const methodPillars = [
  {
    ...
    sections: [
      { sub: "RAG Systems Auto-Correctifs", items: ["Retrieval Augmented Generation", "Intégration données externes temps réel", "Apprentissage continu, pas figé"] },
      { sub: "MCP — Model Context Protocol", items: ["Orchestration fine entre agents", "Contrôle déterministe (pas aléatoire)", "Agents coordonnés, pas autonomes non supervisés"] },
    ],
  },
  {
    num: "2", color: ORANGE,
    ...
    sections: [
      { sub: "Principes fondateurs", items: ["Ingénierie déterministe, pas aléatoire", "Focus UX/Product Design", "Architecture optimisée pour la vitesse"] },
    ],
  },
  {
    num: "3", color: GREEN,
    ...
    sections: [
      { sub: "Intégrations natives", items: ["Connexion outils existants (Salesforce, Teams, Copilot)", "APIs & intégrations sur-mesure"] },
    ],
  },
  {
    num: "4", color: VIOLET,
    ...
    sections: [
      { sub: "Architecture modulaire", items: ["Infrastructures modulaires prêtes pour l'IA", "Connexion des outils existants (Salesforce, Teams, Copilot)", "APIs sur-mesure et interopérabilité SI"] },
    ],
  },
];
...
const ventures = [
  {
    color: GREEN, badge: "Spin-off Hospitality", name: "Yemaya", tagline: "AI for Boutique Hotel",
    ...
    status: "En cours de déploiement", statusColor: GREEN,
  },
];
    ...
    <div className="cz">
      ...
      <footer className="cz-footer-wrap" itemScope itemType="https://schema.org/Organization">
        <div className="cz-footer-main">
          ...
          <div>
            ...
            <address className="cz-footer-address" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
              ...
              <a href="mailto:hello@catapulz.ai" style={{ color: "#555570", textDecoration: "none" }}>hello@catapulz.ai</a><br />
        ...
        <div className="cz-footer-bottom">
          <p className="cz-footer-copy">© {new Date().getFullYear()} CatapulZ AI — Tous droits réservés · SIRET en cours d'enregistrement</p>
